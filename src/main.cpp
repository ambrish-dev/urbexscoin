...
const string strMessageMagic = "Urbexs Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
   ...
   if (nHeight == 1) {
        ...
        nSubsidy = 30 * COIN;
    }else if (nHeight > 530000 && nHeight <= 1060000) {
        nSubsidy = 34 * COIN;
    }else if (nHeight > 1060000 && nHeight <= 1590000) {
        nSubsidy = 37 * COIN;
    }else if (nHeight > 1590000 && nHeight <= 2120000) {
        nSubsidy = 34 * COIN;
    }else if (nHeight > 2120000 && nHeight <= 2380000) {
        nSubsidy = 32 * COIN;
    }else if (nHeight > 2380000 && nHeight <= 2640000) {
        nSubsidy = 31 * COIN;
    }else if (nHeight > 2640000 && nHeight <= 2900000) {
        nSubsidy = 30 * COIN;
    }else if (nHeight > 2900000 && nHeight <= 3160000) {
        nSubsidy = 29 * COIN;
    }else if (nHeight > 3160000 && nHeight <= 3420000) {
        nSubsidy = 28 * COIN;
    }else if (nHeight > 3420000 && nHeight <= 3680000) {
        nSubsidy = 27 * COIN;
    }else if (nHeight > 3680000 && nHeight <= 3940000) {
        nSubsidy = 26 * COIN;
    }else if (nHeight > 3940000 && nHeight <= 4200000) {
        nSubsidy = 25 * COIN;
    }else if (nHeight > 4200000 && nHeight <= 4460000) {
        nSubsidy = 24 * COIN;
    }else if (nHeight > 4460000 && nHeight <= 4720000) {
        nSubsidy = 23 * COIN;
    }else if (nHeight > 4720000 && nHeight <= 4980000) {
        nSubsidy = 22 * COIN;
    }else if (nHeight > 4980000 && nHeight <= 5240000) {
        nSubsidy = 21 * COIN;
    }else if (nHeight > 5240000 && nHeight <= 5500000) {
        nSubsidy = 20 * COIN;
    }else if (nHeight > 5500000 && nHeight <= 5760000) {
        nSubsidy = 19 * COIN;
    }else if (nHeight > 5760000 && nHeight <= 6020000) {
        nSubsidy = 18 * COIN;
    }else if (nHeight > 6020000 && nHeight <= 6280000) {
        nSubsidy = 17 * COIN;
    }else if (nHeight > 6280000 && nHeight <= 6540000) {
        nSubsidy = 16 * COIN;
    }else if (nHeight > 6540000 && nHeight <= 6800000) {
        nSubsidy = 15 * COIN;
    }else if (nHeight > 6800000 && nHeight <= 7060000) {
        nSubsidy = 14 * COIN;
    }else if (nHeight > 7060000 && nHeight <= 7320000) {
        nSubsidy = 13 * COIN;
    }else if (nHeight > 7320000 && nHeight <= 7580000) {
        nSubsidy = 12 * COIN;
    }else if (nHeight > 7580000 && nHeight <= 7840000) {
        nSubsidy = 11 * COIN;
    }else if (nHeight > 7840000 && nHeight <= 21000000) {
        nSubsidy = 10 * COIN;
    }
...
int64_t GetProofOfStakeReward(int nHeight, int64_t nCoinAge, int64_t nFees)
{
    ...
    int64_t ret  = 0; // STATIC_POS_REWARD;
	...
	if (nHeight >= 1 && nHeight <= 10000) {
        ...
        ret = 19 * 30.5/100; //69.5%
    } else if (nHeight > 100000 && nHeight <= 110000) {
       ret = 20 * 30/100; //70%
    } else if (nHeight > 110000 && nHeight <= 120000) {
        ret = 21 * 29.5/100; //70.5%
    } else if (nHeight > 120000 && nHeight <= 130000) {
        ret = 22 * 29/100; //70%
    } else if (nHeight > 130000 && nHeight <= 140000) {
        ret = 23 * 28.5/100; //70%
    ...
    if (IsProofOfStake())
    {
        ...
        if (pindex->nHeight >= GetForkHeightOne())
        {
            ...
            if (foundPaymentAndPayee)
            {
                ...
                CUrbexcoinAddress address2(address1);
...
{
    int64_t ret = blockValue * 1/10; //10%
	if (nHeight >= 1 && nHeight <=  10000) {
         ret = blockValue * 65/100; //65%
    } else if (nHeight > 10000 && nHeight <=  20000) {
        ret = blockValue * 65.5/100; //65%
    } else if (nHeight > 20000 && nHeight <= 30000) {
        ret = blockValue * 66/100; //65%
    } else if (nHeight > 30000 && nHeight <= 40000) {
        ret = blockValue * 66.5/100; //65%
    } else if (nHeight > 40000 && nHeight <= 50000) {
        ret = blockValue * 67/100; //65%
    } else if (nHeight > 50000 && nHeight <= 60000) {
         ret = blockValue * 67.5/100; //65%
    } else if (nHeight > 60000 && nHeight <= 70000) {
         ret = blockValue * 68/100; //65%
    } else if (nHeight > 70000 && nHeight <= 80000) {
         ret = blockValue * 68.5/100; //65%
    } else if (nHeight > 80000 && nHeight <= 90000) {
         ret = blockValue * 69/100; //65%
    } else if (nHeight > 90000 && nHeight <= 100000) {
        ret = blockValue * 69.5/100; //69.5%
    } else if (nHeight > 100000 && nHeight <= 110000) {
       ret = blockValue * 70/100; //70%
    } else if (nHeight > 110000 && nHeight <= 120000) {
        ret = blockValue * 70.5/100; //70.5%
    } else if (nHeight > 120000 && nHeight <= 130000) {
        ret = blockValue * 71/100; //70%
    } else if (nHeight > 130000 && nHeight <= 140000) {
        ret = blockValue * 71.5/100; //70%
    } else if (nHeight > 140000 && nHeight <= 150000) {
        ret = blockValue * 72/100; //70%
    } else if (nHeight > 150000 && nHeight <= 160000) {
        ret = blockValue * 72.5/100; //70%
    } else if (nHeight > 160000 && nHeight <= 170000) {
        ret = blockValue * 73/100; //70%
    } else if (nHeight > 170000 && nHeight <= 180000) {
        ret = blockValue * 73.5/100; //70%
    } else if (nHeight > 180000 && nHeight <= 190000) {
        ret = blockValue * 74/100; //70%
    } else if (nHeight > 190000 && nHeight <= 200000) {
        ret = blockValue * 74.5/100; //70%
    } else if (nHeight > 200000 && nHeight <= 210000) {
        ret = blockValue * 75/100; //70%
    } else if (nHeight > 210000 && nHeight <= 220000) {
        ret = blockValue * 75.5/100; //70%
    } else if (nHeight > 220000 && nHeight <= 230000) {
        ret = blockValue * 76/100; //70%
    } else if (nHeight > 230000 && nHeight <= 240000) {
        ret = blockValue * 76.5/100; //70%
    } else if (nHeight > 240000 && nHeight <= 250000) {
        ret = blockValue * 77/100; //70%
    } else if (nHeight > 250000 && nHeight <= 260000) {
       ret = blockValue * 77.5/100; //70%
    } else if (nHeight > 260000 && nHeight <= 270000) {
        ret = blockValue * 78/100; //70%
    } else if (nHeight > 270000 && nHeight <= 280000) {
        ret = blockValue * 78.5/100; //70%
    } else if (nHeight > 280000 && nHeight <= 290000) {
        ret = blockValue * 79/100; //70%
    } else if (nHeight > 290000 && nHeight <= 300000) {
        ret = blockValue * 79.5/100; //70%
    } else if (nHeight > 300000 && nHeight <= 310000) {
        ret = blockValue * 80/100; //70%
    } else if (nHeight > 310000 && nHeight <= 320000) {
       ret = blockValue * 80.5/100; //70%
    } else if (nHeight > 320000 && nHeight <= 330000) {
       ret = blockValue * 81/100; //70%
    } else if (nHeight > 330000 && nHeight <= 340000) {
        ret = blockValue * 81.5/100; //70%
    } else if (nHeight > 340000 && nHeight <= 350000) {
        ret = blockValue * 82/100; //70%
    } else if (nHeight > 350000 && nHeight <= 360000) {
        ret = blockValue * 82.5/100; //70%
    }else if (nHeight > 360000 && nHeight <= 370000) {
        ret = blockValue * 83/100; //70%
    }else if (nHeight > 370000 && nHeight <= 380000) {
        ret = blockValue * 83/100; //70%
    }else if (nHeight > 380000 && nHeight <= 390000) {
        ret = blockValue * 84/100; //70%
    }else if (nHeight > 390000 && nHeight <= 400000) {
        ret = blockValue * 84.5/100; //70%
    }else if (nHeight > 400000 && nHeight <= 410000) {
       ret = blockValue * 85/100; //70%
    }else if (nHeight > 410000 && nHeight <= 420000) {
        ret = blockValue * 85.5/100; //70%
    }else if (nHeight > 420000 && nHeight <= 430000) {
        ret = blockValue * 86/100; //70%
    } else if (nHeight > 430000 && nHeight <= 440000) {
        ret = blockValue * 86.5/100; //70%
    } else if (nHeight > 440000 && nHeight <= 450000) {
        ret = blockValue * 87/100; //70%
    }else if (nHeight > 450000 && nHeight <= 460000) {
        ret = blockValue * 87.5/100; //70%
    }else if (nHeight > 460000 && nHeight <= 470000) {
       ret = blockValue * 88/100; //70%
    }else if (nHeight > 470000 && nHeight <= 480000) {
        ret = blockValue * 88.5/100; //70%
    }else if (nHeight > 480000 && nHeight <= 490000) {
        ret = blockValue * 89/100; //70%
    }else if (nHeight > 490000 && nHeight <= 500000) {
        ret = blockValue * 89.5/100; //70%
    }else if (nHeight > 500000 && nHeight <= 510000) {
        ret = blockValue * 90/100; //90%
    }else if (nHeight > 510000 && nHeight <= 520000) {
        ret = blockValue * 90/100; //90%
    }else if (nHeight > 520000 && nHeight <= 530000) {
       ret = blockValue * 90/100; //90%
