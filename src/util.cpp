...
int nAnonymizeUrbexsAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Urbexs
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Urbexs
    // Mac: ~/Library/Application Support/Urbexs
    // Unix: ~/.Urbexs
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Urbexs";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Urbexs.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Urbexsd.pid"));
