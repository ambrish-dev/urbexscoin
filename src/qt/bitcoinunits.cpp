...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Urbexs");
    case mBTC: return QString("Milli-Urbexss (1 / 1,000)");
    case uBTC: return QString("Micro-Urbexss (1 / 1,000,000)");
    default: return QString("???");
    }
}
